...
// Jinxes per character
const jinxes = {
  // Townsfolk
  acrobat: [],
  alchemist: [
    { character: 'boffin', description: 'If the Alchemist has the Boffin ability, the Alchemist does not learn what ability the Demon has.' },
    { character: 'marionette', description: 'An Alchemist-Marionette has no Marionette ability & the Marionette is in play.' },
    { character: 'mastermind', description: 'An Alchemist-Mastermind has no Mastermind ability & the Mastermind is not-in-play.' },
    { character: 'organgrinder', description: 'If the Alchemist has the Organ Grinder ability, the Organ Grinder is in play & if both the Alchemist and Organ Grinder are sober, both are drunk.' },
    { character: 'spy', description: 'If the Alchemist has the Spy ability, they do not, and a Spy is in play. Each day, after the execution phase, the living Alchemist may publicly guess a living player as the Spy. If correct, the Demon must choose the Spy tonight.' },
    { character: 'summoner', description: 'The Alchemist-Summoner does not get bluffs, and chooses which Demon but not which player. If they die before this happens, evil wins. [No Demon]' },
    { character: 'widow', description: 'If the Alchemist has the Widow ability, they do not, and a Widow is in play. Each day, after the execution phase, the living Alchemist may publicly guess a living player as the Widow. If correct, the Demon must choose the Widow tonight.' },
...
const reminderTokens = {
  ...
  choirboy: [],
  clockmaker: [],
  courtier: ['courtier_1.png', 'courtier_2.png', 'courtier_3.png', 'courtier_no_ability.png'],
  cultleader: [],
  dreamer: [],
  empath: [],
  engineer: ['engineer.png'],
  exorcist: ['exorcist.png'],
  farmer: [],
  fisherman: ['fisherman.png'],
  flowergirl: ['flowergirl_not_voted.png', 'flowergirl_voted.png'],
  fool: ['fool.png'],
  fortuneteller: ['fortuneteller.png'],
  gambler: ['gambler.png'],
  general: [],
  gossip: ['gossip.png'],
  grandmother: ['grandmother_dead.png', 'grandmother_grandchild.png'],
  highpriestess: [],
  huntsman: ['huntsman.png'],
  innkeeper: ['innkeeper_drunk.png', 'innkeeper_safe.png'],
  investigator: ['investigator_minion.png', 'investigator_wrong.png'],
  juggler: ['juggler.png'],
  king: [],
  knight: ['knight.png'],
  librarian: ['librarian_outsider.png', 'librarian_wrong.png'],
  lycanthrope: ['lycanthrope.png'],
  magician: [],
  mathematician: ['mathematician.png'],
  mayor: [],
  minstrel: ['minstrel.png'],
  monk: ['monk.png'],
  nightwatchman: ['nightwatchman.png'],
  noble: ['noble.png'],
  oracle: [],
  pacifist: [],
  philosopher: ['philosopher.png', 'philosopher_drunk.png'],
  pixie: ['pixie_ability.png', 'pixie_mad.png'],
  poppygrower: ['poppygrower.png'],
  preacher: ['preacher.png'],
  princess: [],
  professor: ['professor_ability.png', 'professor_alive.png'],
  ravenkeeper: [],
  sage: [],
  sailor: ['sailor.png'],
  savant: [],
  seamstress: ['seamstress.png'],
  shugenja: [],
  slayer: ['slayer.png'],
  snakecharmer: ['snakecharmer.png'],
  soldier: [],
  steward: ['steward.png'],
  tealady: ['tealady.png'],
  towncrier: ['towncrier_nominated.png', 'towncrier_not_nominated.png'],
  undertaker: ['undertaker.png'],
  villageidiot: ['villageidiot.png'],
  virgin: ['virgin.png'],
  washerwoman: ['washerwoman_townsfolk.png', 'washerwoman_wrong.png'],
  // Outsiders
  barber: ['barber.png'],
  butler: ['butler.png'],
  damsel: ['damsel.png'],
  ...
  klutz: [],
  lunatic: ['lunatic.png'],
  moonchild: ['moonchild.png'],
  mutant: [],
  ogre: [],
  plaguedoctor: ['plaguedoctor.png'],
  politician: [],
  puzzlemaster: ['puzzlemaster_drunk.png', 'puzzlemaster_guess.png'],
  recluse: [],
  saint: [],
  snitch: [],
  ...
  zealot: [],
  // Minions
  assassin: ['assassin_ability.png', 'assassin_dead.png'],
  baron: [],
  boffin: [],
  boomdandy: [],
  cerenovus: ['cerenovus.png'],
  devilsadvocate: ['devilsadvocate.png'],
  eviltwin: ['eviltwin.png'],
  fearmonger: ['fearmonger.png'],
  goblin: ['goblin.png'],
  godfather: ['godfather_dead.png', 'godfather_died.png'],
  harpy: ['harpy_2nd.png', 'harpy_mad.png'],
  marionette: ['marionette.png'],
  mastermind: [],
  mezepheles: ['mezepheles_ability.png', 'mezepheles_evil.png'],
  organgrinder: ['organgrinder.png'],
  pithag: [],
  poisoner: ['poisoner.png'],
  psychopath: [],
  scarletwoman: ['scarletwoman.png'],
  spy: [],
  summoner: ['summoner_1.png', 'summoner_2.png', 'summoner_3.png'],
  vizier: [],
  widow: ['widow_knows.png', 'widow_poisoned.png'],
  witch: ['witch.png'],
  wizard: [],
  wraith: [],
  xaan: [],
  // Demons
  alhadikhia: ['alhadikhia_1.png', 'alhadikhia_2.png', 'alhadikhia_3.png'],
  fanggu: ['fanggu_dead.png', 'fanggu_once.png'],
  imp: ['imp.png'],
  kazali: ['kazali.png'],
  legion: ['legion_about_to_die.png', 'legion_die.png'],
  leviathan: ['leviathan_1.png', 'leviathan_2.png', 'leviathan_3.png', 'leviathan_4.png', 'leviathan_5.png', 'leviathan_executed.png'],
  lilmonsta: ['lilmonsta_dead.png', 'lilmonsta_demon.png'],
  lleech: ['lleech_dead.png', 'lleech_poisoned.png'],
  lordoftyphon: [],
  nodashii: ['nodashii_dead.png', 'nodashii_poisoned.png'],
  ojo: ['ojo.png'],
  po: ['po_attacks.png', 'po_dead.png'],
  pukka: ['pukka_dead.png', 'pukka_poisoned.png'],
  riot: [],
  shabaloth: ['shabaloth_alive.png', 'shabaloth_dead.png'],
  vigormortis: ['vigormortis_ability.png', 'vigormortis_dead.png', 'vigormortis_poisoned.png'],
  vortox: ['vortox.png'],
  yaggababble: ['yaggababble.png'],
  zombuul: ['zombuul_dead.png', 'zombull_died_today.png']
}
  ...
  Object.entries(characterGroups).reduce((acc, [type, slugs]) => {
    slugs.forEach(slug => {
      acc[slug] = {
        ...
        blurb: blurbs[slug] || '',
        jinxes: jinxes[slug] || [],
        reminderTokens: reminderTokens[slug] || []
      }
    })
    return acc
  }, {})
